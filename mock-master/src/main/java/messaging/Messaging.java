...
public class Messaging {
    ...
    private static final String PROJECT_ID = "amplify-android-project";
    ...
    private static final String TITLE = "Amplify";
    private static final String BODY = "Your favourite song is playing!";
    ...
    public static void sendCommonMessage() throws IOException {
        ...
        System.out.println("Your favourite song is playing !");
    ...
    private static JsonObject buildNotificationMessage() {
        ...
        jMessage.addProperty(
                "token",
                "f7X4Z94q0_U:APA91bEGbYzW8CyoGQwgbxaQnMFvcNcK2YWoQOIJywv9GDrIv6radY0-5MZQbJ6h5py1hdmyCZqbTsOUlMFEcFl6yDq02-pCT5UGT2sI2cY-cFjSctK9ksh6sAMX41b1Gx6m0C98XtG3");
